"""
Django settings for employment_placement_app project.
...
ROOT_URLCONF = 'employment_placement_app.urls'
...
#WSGI_APPLICATION = 'employment_placement_app.wsgi.application'
